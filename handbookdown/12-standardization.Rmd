...
*P~0~* std ambient pressure sea level (2116.22 lb/ft² = 29.921 in Hg)
...
*T~0~* ambient temperature sea level standard (288.15 °K=15.0 °C)
...
initial glide slope, γ~0~ =sin^-1^ \[*h~0~*dot\]*/* *V~To~*

initial load factor, *N~z~* = cosγ~0~ (assumes *dγ~0~/dt* =0)
