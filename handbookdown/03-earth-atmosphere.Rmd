...
\(g_{lsl}\)* at the equator and the poles varies ±0.27% from \(g_0\).
...
| Geopotential     | \(h\)   | Required because \(g\) changes with height. If potential energy is calculated using sea level weight ( \(W_{SL} = mg_0\)) instead of actual weight (\(W = mg\)), then the altitude must be lower. \(h = W/W_{SL} h_G \) |
