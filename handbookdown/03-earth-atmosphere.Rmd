...
\[
H_p \left[ \text{ft} \right] = \frac{ 1-\left(\frac{P_a}{P_o})^{0.190\,2632}^ }{6.875\,5856 \times 10^{-6}}
\]

In the troposphere (ambient pressure between 114.347 and 472.683 psf or between 5475 and 22632.1 Pascal)

*H*~p~ \[ft\] = 36\,089+\[ln(*P_a~/P_o)+1.498\,966\]/ 0.000\,048\,063
 **\
**
...
*e^2\ ^*= eccentricity squared; $e^{2} = 1 - \left( \frac{a}{b} \right)^{2} = 2 \bullet f - f^{2}$= 0.006\,694 380 02290 (Earth, per WGS84).
