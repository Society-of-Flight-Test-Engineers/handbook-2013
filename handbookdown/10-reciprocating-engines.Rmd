...
• This ratio must be between  0.05 and  0.125 to burn.

• Best power typically occurs at mixture ratio of 0.075 to 0.08.

• Best economy typically occurs at a ratio of  0.0625
...
where *T~as~* is the standard absolute ambient temperature at the test altitude, and, below the tropopause, is calculated as *T~as~* = 288.15- 0.001 9812*H~c~* .
