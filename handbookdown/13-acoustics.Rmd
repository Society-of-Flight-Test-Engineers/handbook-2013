...
*x~0~* reference value of quantity
...
octave a band with the upper freq exactly twice the lower freq. (common octaves include  0.0375- 0.075,  0.075- 0.15, 15- 0.3,  0.6-1.2, 1.2-2.4, 2.4-4.8, 4.8-9.6 k*Hz*).
...
Velocity (*L~v~*) 20log(*v/v~0~*) *v~0~* = 10 *nm/s^2^*

Intensity (*L~I~*) 10log(*I/I~0~*) *I~0~*= 1 *pW/m^2^*
...
*I~0~* = 10^-12^ watt/m^2^ reference intensity
...
200 199.5 -10.8 -2.0  0.0

250 251.2 -8.7 -1.4  0.0

315 316.2 -6.6 -0.9  0.0

400 398.1 -4.8 -0.5  0.0

500 501.2 -3.2 -0.3  0.0

630 631.0 -1.9 -0.1  0.0

800 794.3 -0.8  0.0  0.0

1,000 1,000  0.0  0.0  0.0

1,250 1,259 0.6  0.0  0.0

1,600 1,585 1.0  0.0 -0.1
