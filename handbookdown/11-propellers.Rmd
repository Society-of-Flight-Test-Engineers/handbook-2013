...
Static Thrust = where \(N\) = Propeller \(\text{RPM}\) Determine isolated propeller in-flight effi

 

ciency (\(\eta\)) from the appropriate **"Flight Charts."** They are typically presented in one of two forms.
