...
>
> \~  used in flow outside of boundary layers at M \<  0.7

• Incompressible, inelastic, viscous

> \~  used for boundary layer studies at M \<  0.7
...
For air: *S* =110.4 *K* = 199 *R; n= 0.67*

For air at 273 K: μ~o~= 1.717x10^-5^ \[kg/m s\] = 3.59x10^-7^ \[slug/ft s\]

Inserting air values (*T~K~*=Kelvin and T*~R~*=Rankine) into Sutherland law gives
