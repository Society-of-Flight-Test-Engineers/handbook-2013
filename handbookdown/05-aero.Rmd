...
 
  ...
  [05001]: media/05/image1.png {width="2.9in" height="1.7402777777777778in"}
  [05002]: media/05/image2.png {width="0.8444444444444444in" height="0.5125in"}
  [05003]: media/05/image3.png {width="0.8125in" height="1.625in"}
  [05004]: media/05/image4.png {width="1.4381944444444446in" height="0.4583333333333333in"}
  [05005]: media/05/image5.png {width="1.729861111111111in" height="1.375in"}
  [05006]: media/05/image6.png {width="4.4in" height="1.25in"}
  [05007]: media/05/image7.png {width="2.9270833333333335in" height="1.93125in"}
  [05008]: media/05/image8.png {width="1.5770833333333334in" height="0.6298611111111111in"}
  [05009]: media/05/image9.png {width="4.4in" height="1.125in"}
  [05010]: media/05/image10.png {width="1.6979166666666667in" height="0.5361111111111111in"}
  [05011]: media/05/image11.png {width="2.6666666666666665in" height="2.3125in"}
  [05012]: media/05/image12.png {width="3.55in" height="1.7201388888888889in"}
  [05013]: media/05/image13.png {width="2.1152777777777776in" height="1.1875in"}
  [05014]: media/05/image14.png {width="1.9375in" height="1.1243055555555554in"}
  [05015]: media/05/image15.png {width="4.4in" height="1.4409722222222223in"}
  [05016]: media/05/image16.png {width="2.857638888888889in" height="2.5118055555555556in"}
  [05017]: media/05/image17.png {width="1.3763888888888889in" height="0.6in"}
  [05018]: media/05/image18.png {width="3.5in" height="1.71875in"}
  [05019]: media/05/image19.png {width="2.65in" height="2.65in"}
  [05020]: media/05/image20.png {width="3.192361111111111in" height="0.6965277777777777in"}
  [05021]: media/05/image21.png {width="2.7in" height="2.645138888888889in"}
  [05022]: media/05/image22.png {width="3.147222222222222in" height="1.1743055555555555in"}
  [05023]: media/05/image23.png {width="2.3125in" height="1.86875in"}
  [05024]: media/05/image24.png {width="4.4in" height="1.75in"}
  [05025]: media/05/image25.png {width="3.9125in" height="1.625in"}
  [05026]: media/05/image33.png {width="3.9055555555555554in" height="1.625in"}
  [05027]: media/05/image34.png {width="2.3916666666666666in" height="0.5625in"}
  [05028]: media/05/image35.png {width="1.304861111111111in" height="0.6611111111111111in"}
  [05029]: media/05/image36.png {width="0.7708333333333334in" height="0.46805555555555556in"}
  [05030]: media/05/image37.png {width="3.75in" height="0.5048611111111111in"}
  [05031]: media/05/image38.png {width="2.0166666666666666in" height="0.8125in"}
  [05032]: media/05/image39.png {width="3.4270833333333335in" height="1.7291666666666667in"}
  [05033]: media/05/image43.png {width="3.3493055555555555in" height="1.9527777777777777in"}
  [05034]: media/05/image44.png {width="2.045138888888889in" height="0.4479166666666667in"}
  [05035]: media/05/image45.png {width="1.0486111111111112in" height="0.9375in"}
  [05036]: media/05/image46.png {width="4.4in" height="1.4375in"}
  [05037]: media/05/image47.png {width="2.75in" height="1.3222222222222222in"}
  [05038]: media/05/image48.png {width="2.595833333333333in" height="1.375in"}
  [05039]: media/05/image49.png {width="4.4in" height="3.0in"}
  [05040]: media/05/image50.png {width="2.78125in" height="1.25in"}
  [05041]: media/05/image51.png {width="4.4in" height="2.125in"}
  [05042]: media/05/image52.png {width="3.0in" height="1.4819444444444445in"}
  [05043]: media/05/image53.png {width="1.2527777777777778in" height="0.5625in"}
  [05044]: media/05/image54.png {width="2.3125in" height="0.5215277777777778in"}
  [05045]: media/05/image55.png {width="3.875in" height="1.4375in"}
  [05046]: media/05/image57.png {width="2.029166666666667in" height="2.0625in"}
  [05047]: media/05/image58.png {width="3.25in" height="0.5215277777777778in"}
  [05048]: media/05/image59.png {width="3.5618055555555554in" height="2.25in"}
  [05049]: media/05/image60.png {width="2.5340277777777778in" height="0.8013888888888889in"}
  [05050]: media/05/image61.png {width="4.145833333333333in" height="0.6875in"}
  [05051]: media/05/image62.png {width="4.4in" height="3.5in"}
  [05052]: media/05/image63.png {width="2.58125in" height="2.0340277777777778in"}
  [05053]: media/05/image64.png {width="3.6in" height="2.6555555555555554in"}
  [05054]: media/05/image65.png {width="3.5215277777777776in" height="0.5555555555555556in"}
  [05055]: media/05/image66.png {width="4.4in" height="3.75in"}
  [05056]: media/05/image67.png {width="2.5375in" height="2.125in"}
  [05057]: media/05/image68.png {width="1.5347222222222223in" height="0.375in"}
  [05058]: media/05/image69.png {width="1.7652777777777777in" height="0.5in"}
  [05059]: media/05/image70.png {width="2.3125in" height="0.9090277777777778in"}
  [05060]: media/05/image71.png {width="2.2354166666666666in" height="0.9375in"}
  [05061]: media/05/image72.png {width="2.2979166666666666in" height="0.7222222222222222in"}
  [05062]: media/05/image73.png {width="2.1013888888888888in" height="1.75625in"}
  [05063]: media/05/image74.png {width="2.0631944444444446in" height="0.4375in"}
  [05064]: media/05/image75.png {width="2.136111111111111in" height="1.8625in"}
  [05065]: media/05/image76.png {width="2.375in" height="1.729861111111111in"}
  [05066]: media/05/image77.png {width="3.027083333333333in" height="0.5104166666666666in"}
  [05067]: media/05/image78.png {width="5.125in" height="1.6875in"}
  [05068]: media/05/image79.png {width="1.7645833333333334in" height="0.5215277777777778in"}
  [05069]: media/05/image80.png {width="2.6354166666666665in" height="3.4375in"}
  [05070]: media/05/image81.png {width="3.1625in" height="1.6368055555555556in"}
  [05071]: media/05/image82.png {width="1.8125in" height="0.5159722222222223in"}
  [05072]: media/05/image83.png {width="2.9256944444444444in" height="3.0375in"}
  [05073]: media/05/image84.png {width="3.263888888888889in" height="3.1145833333333335in"}
  [05074]: media/05/image86.png {width="3.875in" height="1.4222222222222223in"}
  [05075]: media/05/image87.png {width="4.0in" height="0.5659722222222222in"}
  [05076]: media/05/image88.png {width="1.8298611111111112in" height="0.5520833333333334in"}
  [05077]: media/05/image89.png {width="3.25in" height="3.7534722222222223in"}
  [05078]: media/05/image93.png {width="4.4in" height="0.5in"}
  [05079]: media/05/image94.png {width="1.25in" height="0.5625in"}
  [05080]: media/05/image95.png {width="3.3569444444444443in" height="1.9375in"}
  [05081]: media/05/image96.png {width="2.604861111111111in" height="0.5in"}
  [05082]: media/05/image97.png {width="2.875in" height="2.0868055555555554in"}
  [05083]: media/05/image98.png {width="1.5in" height="0.5277777777777778in"}
