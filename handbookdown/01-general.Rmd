...
|$Α$ |$\alpha$ |Alpha|æl-fə|
|$Β$ |$\beta$ |Beta|bei-tə|
|$\Gamma$ |$\gamma$ |Gamma|gæ-mə|
|$\Delta$ |$\delta$  |Delta|del-tə|
|$Ε$ |$\epsilon$ |Epsilon|eps-ill-aan|
|$Ζ$ |$\zeta$ |Zeta|zei-tə|
|$Η$ |$\eta$ |Eta |ei-tə|
|$\Theta$ |$\theta$ |Theta|thei-tə|
|$Ι$ |$\iota$ |Iota|aai-oh-tə|
|$Κ$ |$\kappa$ |Kappa|kæ-pə|
|$\Lambda$ |$\lambda$ |Lambda|læm-də|
|$M$| $\mu$ |Mu|myoo|
|$Ν$ |$\nu$ |Nu|nyoo|
|$\Xi$ |$\xi$ |Xi|ksaai |
|$Ο$ |$ο$ |Omicron|oh-mə-kraan|
|$\Pi$ |$\pi$ |Pi|paai|
|$P$ |$\rho$    |Rho|roh|
|$\Sigma$ |$\sigma$ |Sigma|sig-mə|
|$Τ$ |$\tau$ |Tau| taa’u|
|$\Upsilon$ |$\upsilon$|Upsilon|oops-ill-on|
|$\Phi$ |$\phi$ |Phi|faai|
|$Χ$ |$\chi$ |Chi|kaai|
|$\Psi$ |$\psi$ |Psi|psaai|
|$\Omega$ |$\omega$ |Omega|oh-meg-ə|
...
$\mu$ coefficient of absolute viscosity =  ρν

$\mu$ Mach cone angle

ν kinematic viscosity = $\mu$/*g*
