...
Tables are covered here
  https://bookdown.org/yihui/bookdown/tables.html
and here
  https://pandoc.org/MANUAL.html#tables

I haven't got the (\#tab:label) labels working, yet

I find https://www.tablesgenerator.com/markdown_tables to be 
indispensable for working with markdown tables. It's how I
got the big conversion factor table below formatted.

1) Insert the `|` pipe characters where you want column delimiters
2) Copy the table
3) Go to https://www.tablesgenerator.com/markdown_tables 
4) Make sure Markdown Tables is selected
5) Select File...Paste table data...
6) Paste the table in the text field
7) The formatted table will then be available below for copying and pasting
...
|                          | sphere         | 4π             | steradians^[solid angle measurement] |
|                          |                |                |                                      |
...
[comment]: # Just to adopt a convention, I use italics first then subscript. For example X*~1~* instead of X~*1*~.
...
|c speed of light in a vacuum (186,282 miles/sec = 299,792,500 meters/sec)
...
|V~LE~ max speed with landing gear extended
...
|WPT waypoint
|wrt with respect to
[comment]: input the equation for this ", corrected fuel flow parameter"
|W/S wing loading
|W~f~ fuel flow (lb/hr)
...
![][11] specific heat at constant volume
...
![][15]6) Assume constant specific heat and integrate:
...
 
  ...
  [2]:  media/media/image2.png {width="6.5in" height="3.4063156167979in"}
  [3]:  media/media/image3.png {width="6.5in" height="4.874305555555556in"}
  [4]:  media/media/image4.png {width="0.7902777777777777in" height="0.6381944444444444in"}
  [5]:  media/media/image5.png {width="0.8236111111111111in" height="2.3604166666666666in"}
  [6]:  media/media/image6.png {width="2.470138888888889in" height="0.5in"}
  [7]:  media/media/image7.png {width="1.58125in" height="0.5in"}
  [8]:  media/media/image8.png {width="2.4881944444444444in" height="0.75in"}
  [9]:  media/media/image9.png {width="0.78125in" height="0.27708333333333335in"}
  [10]: media/media/image10.png {width="0.7402777777777778in" height="0.4861111111111111in"}
  [11]: media/media/image11.png {width="0.6673611111111111in" height="0.4861111111111111in"}
  [12]: media/media/image12.png {width="0.5006944444444444in" height="0.5in"}
  [13]: media/media/image13.png {width="0.8548611111111111in" height="0.4305555555555556in"}
  [14]: media/media/image14.png {width="0.6986111111111111in" height="0.4305555555555556in"}
  [15]: media/media/image15.png {width="1.78125in" height="0.48541666666666666in"}
  [16]: media/media/image16.png {width="1.2930555555555556in" height="0.48541666666666666in"}
  [17]: media/media/image17.png {width="0.6958333333333333in" height="0.5in"}
  [18]: media/media/image18.png {width="0.9152777777777777in" height="0.5548611111111111in"}
  [19]: media/media/image19.png {width="1.8055555555555556in" height="0.48541666666666666in"}
  [20]: media/media/image20.png {width="1.3055555555555556in" height="0.48541666666666666in"}
  [21]: media/media/image21.png {width="0.8541666666666666in" height="0.42986111111111114in"}
  [22]: media/media/image22.png {width="0.9152777777777777in" height="0.6381944444444444in"}
  [23]: media/media/image23.png {width="0.8180555555555555in" height="0.5548611111111111in"}
  [24]: media/media/image24.jpeg {width="6.08125in" height="8.9375in"}