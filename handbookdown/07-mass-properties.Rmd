...
| \(\epsilon\)      | inclination of principle axis (positive if tilted down).                                      |              |
...
If not possible to rig wing attach points in line with the *cg*, then keep the springs parallel to each other and measure the angle \phi.  
