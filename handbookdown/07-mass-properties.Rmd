...
|-------------------|-----------------------------------------------------------------------------------------------|--------------|
| \(\Delta I_{\text{am}}\) | equivalent moment of inertia contribution of the air                                          | [slug-ft^2^] |
| \(\Delta I_{\text{te}}\) | correction for test equipment mass                                                            | [slug-ft^2^] |
...
| \(K_{\text{tot}}\)       | total radius of gyration (includes effect of offset pivot)                                    |              |
| \(K_o\)           | component of spring stiffness perpendicular to vehicle motion                                 |              |
| \(k\)             | spring constant                                                                               | [lb/ft]      |
| \(L\)             | rolling moment                                                                                |              |
| \(l_{\text{eff}}\)       | effective pendulum length                                                                     |              |
| \(m\)             | mass                                                                                          |              |
...
\[
\begin{align}
I_{x_b} &= \int \left( y^2 + z^2 \right) dm \\
I_{y_b} &= \int \left( x^2 + z^2 \right) dm \\
I_{z_b} &= \int \left( x^2 + y^2 \right) dm \\
\end{align}
\]
...
For \(I_{z_b}\) test, set spring assembly tilt angle parallel to floor (*\delta *= 0).
...
### Measuring Axis of Inclination and \(I_xz\)
