...
Given a real number, \(m\), and vectors \(\bar{A}\) and \(\bar{B}\), where the *i*th component of \(\bar{A}\) is given by \(a_i\), we define scalar multiplication addition \(m \bar{A}\) component-wise, such that the *i*th component of \(m \bar{A}\) is given by \(m a_i\). 
