...
Monthly interest rate = \(MIR = \frac{ \textrm{annual interest rate} }{12} \)
...
Monthly payment = \( \left[ \textrm{amount financed} \right] \left[ \frac{MIR}{1 - \left( 1 + MIR \right)^{-\#months}} \right] \)
...
## Probability and Statistics (raw)
